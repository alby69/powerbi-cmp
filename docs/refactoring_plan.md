...
|-------|-------|--------|------|
| 1 — Quick Wins | 2-3h | 🔴 High (RAM, performance) | 🟢 Low |
| 2 — Standardization | 4-6h | 🟡 Medium (maintainability) | 🟡 Medium (rename breaks refs) |
| 3 — DAX & Model | 8-16h | 🔴 High (performance, maintainability) | 🔴 High (regression risk) |
| 4 — Documentation | 4-6h | 🟢 Low (process) | 🟢 Low |
| **Total** | **18-31h** | | |
...
Week 1: Phase 1 (Quick Wins)
  ├── Mon: Disable Auto Date/Time, delete LocalDateTable
  └── Tue: Audit relationships, remove unused columns

Week 2-3: Phase 2 (Standardization)
  ├── Wed-Thu: Rename tables, apply naming convention
  └── Fri: Add Display Folders, document measures

Week 3-5: Phase 3 (Optimization)
  ├── Mon-Wed: Eliminate duplicate measures, consolidate CGs
  └── Thu-Fri: Star schema refactoring, data type optimization

Week 5-6: Phase 4 (Documentation)
  ├── Mon: Finalize data dictionary
  └── Tue: Review & sign-off
```
...
|--------|--------|---------------|
| Tables | 75 | ~55 (-20 LocalDateTable + merged) |
| Relationships | 71 | ~50 |
| Measures | 301+ | ~200 (consolidated) |
| LocalDateTable | 17 | 0 |
| Bidirectional relationships | 5+ | <2 |
| Data Dictionary | ❌ | ✅ |
| Naming Convention | ❌ | ✅ |
